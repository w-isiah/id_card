...
def register_blueprints(app):
    ...
    modules = ['authentication', 'home', 'pupils', 'classes', 'fathers', 'mothers', 'guardians', 'subjects', 'teachers', 'gen_ids', 'study_years', 'results', 'reports','grades','dorms','register','promote','streams','rooms','stream_assign']
